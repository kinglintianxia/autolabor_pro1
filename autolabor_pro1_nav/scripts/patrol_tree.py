...
from task_setup import *    # task setup
...
class Patrol():
    def __init__(self):
        ...
        with STAY_HEALTHY:
            ...
            CHECK_BATTERY = MonitorTask("CHECK_BATTERY", "remaining_battery", Int32, self.check_battery)
            ...
            STAY_HEALTHY.add_child(NAV_DOCK_TASK)
